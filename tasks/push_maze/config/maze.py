...
maze_usd_paths = {
    "A": os.path.join(repo_root, "tasks/push_maze/assets/maze/usd/maze_a/maze_a.usd"),
    "B": os.path.join(repo_root, "tasks/push_maze/assets/maze/usd/maze_b/maze_b.usd"),
    "C": os.path.join(repo_root, "tasks/push_maze/assets/maze/usd/maze_c/maze_c.usd"),
}
...
class MazeConfig:
    @staticmethod
    def create_config(usd_path: str) -> ArticulationCfg:
...
MAZEA_CFG = MazeConfig.create_config(maze_usd_paths["A"])
MAZEB_CFG = MazeConfig.create_config(maze_usd_paths["B"])
MAZEC_CFG = MazeConfig.create_config(maze_usd_paths["C"])
