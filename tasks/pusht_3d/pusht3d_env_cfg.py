...
from tasks.pusht_3d.config.ur5e import UR5E_PROBE_CFG
...
@configclass
class PushT3DEnvCfg(DirectRLEnvCfg):
    ...
    object_cfg: RigidObjectCfg = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=os.path.join(repo_root, "tasks/pusht_3d/assets/object/usd/t_block_usd/t_block.usd"),
