...
maze_usd_paths = {
    "A": os.path.join(repo_root, "tasks/maze/assets/maze/usd/maze_a/maze_a.usd"),
    "B": os.path.join(repo_root, "tasks/maze/assets/maze/usd/maze_b/maze_b.usd"),
    "C": os.path.join(repo_root, "tasks/maze/assets/maze/usd/maze_c/maze_c.usd"),
}
