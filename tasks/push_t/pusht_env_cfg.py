...
class PushTEnvCfg(DirectRLEnvCfg):
    ...
    num_actions = 2
    num_observations = 15  # 21
    num_states = 15  # 21
    num_q_space = 15
    max_episode_steps = 600

    # PRM config for observation update
    extracted_goal_idx_policy = (4, 7)  # (4, 10)  # indices of the current observation (obj_pose)
    goal_idx_policy = (12, 15)  # (15, 21)  # indices of the goal observation (goal_pose)
    extracted_goal_idx_critic = (4, 7)  # (4, 10)  # indices of the current critic observation (obj_pose)
    goal_idx_critic = (12, 15)  # (15, 21)  # indices of the goal critic observation (goal_pose)
