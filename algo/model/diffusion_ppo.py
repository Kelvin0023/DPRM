...
from algo.model.diffusion_pg import DiffusionPG


class DiffusionPPO(DiffusionPG):
    def __init__(
        self,
    ...
    def loss(
        ...
        # newlogprobs = newlogprobs.sum(dim=(-1, -2)).view(-1)
        # oldlogprobs = oldlogprobs.sum(dim=(-1, -2)).view(-1)
