...
@hydra.main(config_name="train_pusht_td3", config_path="cfg", version_base="1.2")
...
from algo.main_td3 import Main_TD3
...
def build_learning_env(cfg: DictConfig):
    ...
    agent = Main_TD3(cfg=task_cfg, env=env, output_dir=output_dir)
